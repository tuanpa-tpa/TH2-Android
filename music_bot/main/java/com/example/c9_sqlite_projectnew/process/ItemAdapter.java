...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        holder.tvStatus1.setText("Status1: " + item.getStatus1());
        holder.tvDetail.setText("Detail: "+item.getDetail());
        holder.tvIsCoop.setText(item.isCoop() ? "|  Thich" : "|  Khong");
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder{
        TextView tvName, tvStatus,tvStatus1, tvDetail, tvIsCoop;

        public ItemViewHolder(@NonNull View itemView) {
            super(itemView);
            tvName = itemView.findViewById(R.id.tv_item_name);
            tvStatus = itemView.findViewById(R.id.tv_item_status);
            tvStatus1 = itemView.findViewById(R.id.tv_item_status1);
